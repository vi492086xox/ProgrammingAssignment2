...
makeCacheMatrix <- function(x = matrix()) {
	...
	## The set function takes a new matrix and replaces the previous one.
	## It also changes the cached matrix to NULL since the matrix values
	## have likely changed.
...
## cacheSolve function returns the inverse of a matrix contained in
